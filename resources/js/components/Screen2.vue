        ...
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form @submit.prevent="handleSubmit">
                <div class="mb-4">
                    ...
                    <input type="text" v-model="form.nama" class="border rounded w-full p-2" />
                    <span v-if="errors.nama" class="text-red-500 text-sm">{{ errors.nama }}</span>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 mb-2">Nomor Telpon</label>
                    <input type="text" v-model="form.nomor_telpon" class="border rounded w-full p-2" />
                    <span v-if="errors.nomor_telpon" class="text-red-500 text-sm">{{ errors.nomor_telpon }}</span>
                </div>
                <div class="mb-4">
